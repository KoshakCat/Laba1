...
public class App 
{
    public static void main(String[] args )
    {
        ...
        /*PassCoachService passCoachService = PassCoachService.getInstance();
        TrainService trainService = TrainService.getInstance(passCoachService);
        passCoachService.fillDefaultListOfCoaches();
        trainService.fillDefaultTrain();

        System.out.println(passCoachService.getAllCoaches());
